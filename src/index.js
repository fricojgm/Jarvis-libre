...
app.get('/', (req, res) => res.send('Jarvis-Libre operativo, MACD protegido, Short Volume e Interest activos en modo JSON.'));

app.listen(PORT, () => {
    console.log(`🚀 Servidor en puerto ${PORT} listo, Short Volume y Short Interest activados.`);
});